...
import { isPlatformSuperadmin, isOrgAdmin as userIsOrgAdmin } from '@/lib/roleLabels';
...
export function BaseDeDatosPage() {
  ...
  const isOrgAdmin = superadmin || userIsOrgAdmin({ orgRole, publicMetadata: user?.publicMetadata });
