...
export function DireccionEntregaEditPage() {
  ...
  async function onSave() {
    ...
    setError(null);
    try {
      await apiJson<DireccionEntrega>(direccionEntregaDetailUrl(id, tenantId), () => getToken(), {
        method: 'PATCH',
  ...
  return (
    <CrudPageLayout title="Editar dirección / ruta" backTo={backTo} backLabel="← Volver a direcciones">
      {initialLoading ? (
