...
const TEMPLATE_EXAMPLES: Record<string, object> = {
  viajes: {
    ...
    columns: [
      ...
      { excelHeader: 'MONEDA MONTO', field: 'monedaMonto', type: 'string', required: true },
      ...
      { excelHeader: 'MONEDA FLETE', field: 'monedaPrecioTransportistaExterno', type: 'string', required: true },
